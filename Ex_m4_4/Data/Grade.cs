...
namespace GradesPrototype.Data
{
    ...
    public class Student: IComparable<Student>
    {
        ...
        {
            if (gr.StudentID != this.StudentID)
                throw new ArgumentException("Add grade", "Grade belongs to another student.");

            gr.StudentID = this.StudentID;
        }
    }
    ...
    public class Teacher
    {
        ...
        public void EnrollInClass(Student st)
        {
            if (st.TeacherID != 0)
                throw new ArgumentException("EnrollInClass", "Student allready enrolled in another class.");

            st.TeacherID = this.TeacherID;
        }

        // TODO: Exercise 4: Task 2b: Remove a student from the class for this teacher
        public void RemoveFromClass(Student st)
        {
            if (st.TeacherID != this.TeacherID)
                throw new ArgumentException("RemoveFromClass", "Student not enrolled in this class.");
